/* 测试全局变量 */
jQuery1 = function (ss: string): void {}
...
/* 测试全局enum */
let directives: Directives[] = [Directives.Up, Directives.Down]

/* 测试全局namespace */
jQuery.ajax('/api/get_something', {})
jQuery.version = 34
let Et: jQuery.EventType = jQuery.EventType.KKK
let NE = new jQuery.Event()
NE.blur(Et)
jQuery.fn.extend({})

/* 测试全局interface 和 type */
let dataty: DataType = { name: '', age: 12 }
...
/* 支持嵌套的类型 */
let settings5: jQuery.AjaxSettings = {
    method: 'GET',
